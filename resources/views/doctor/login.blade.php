...
<!--===============================================================================================-->
  <link rel="stylesheet" type="text/css" href="{{ asset('storage/fonts/font-awesome-4.7.0/css/font-awesome.min.css')}}">
<!--===============================================================================================-->
  <link rel="stylesheet" type="text/css" href="{{ asset('storage/fonts/Linearicons-Free-v1.0.0/icon-font.min.css')}}">
<!--===============================================================================================-->
  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100">
        ...
        <form action="{{ route('doctor.login') }}" method="POST" class="login100-form validate-form">
          {{ csrf_field() }}
          ...
          <span class="login100-form-title p-b-43">
            ...
            <ul id="menu">
              <li><a href="{{ url('admin-login') }}" >ADMIN</li></a>
              <li><a class="active" href="{{ url('doctor-login') }}">DOCTOR</li></a>
              <li><a href="{{ url('user-login') }}" >PATIENT</li></a>
            </ul>
          <hr>
          <img src="{{ asset('storage/images/Doctor.png')}}" height="90" width="75" class="center">
        ...
        <div class="login100-more" style="background-image: url('{{ asset('storage/images/bg4login.jpg') }}') ;">
        </div>
      </div>
    </div>
  </div>
