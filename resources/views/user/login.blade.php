        ...
        <form action="{{ route('user.login') }}" method="POST" class="login100-form validate-form">
          ...
          <span class="login100-form-title p-b-43">
            ...
            <ul id="menu">
              ...
              <li><a href="{{ url('doctor-login') }}">DOCTOR</li></a>
              <li><a class="active" href="{{ url('user-login') }}" >PATIENT</li></a>
            </ul>
          <hr>
          <img src="{{ asset('storage/images/Patient.png')}}" height="90" width="75" class="center">
